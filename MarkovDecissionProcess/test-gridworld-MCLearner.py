...
# problem_solver = GridWorldMBSolver(problem, MCLearner, rar=0.5)
# problem_solver.train(200, start_pos=(2, 0))
# #
problem = GridWorld('data/world02.csv', reward={0: -0.04, 1: 100.0, 2: -2.5, 3: np.NaN}, random_rate=0.2)
problem_solver = GridWorldMBSolver(problem, MCLearner, rar=0.9999, radr=0.9995)
problem_solver.train(5000, start_pos=(5, 3), plot=True)
